...
df_1 = pd.read_csv("first_telco.csv")
...
"""The predict method is our POST method, 
which is basically called when we pass all 
the inputs from our front end and click SUBMIT."""
...
"""The run() method of Flask class runs the
